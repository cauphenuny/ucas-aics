...
if __name__ == '__main__':
    ...
    optimizer = _____________________________________________
    #TODO: 在cpu上计算均方误差损失函数
    loss_func = _____________________________________________
    ...
    s1, s2, s3, s4 =_____________________________________________
    #TODO: 对风格特征s1-s4计算格拉姆矩阵并从当前计算图中分离下来,得到对应的s1-s4
    s1 = _____________________________________________
    s2 = _____________________________________________
    s3 = _____________________________________________
    s4 = _____________________________________________
    j = 0
    count = 0
    epochs = 0
    while j <= epochs:
        for i, image in enumerate(data_loader):
            ...
            loss_s1 =_____________________________________________
            loss_s2 =_____________________________________________
            loss_s3 =_____________________________________________
            loss_s4 =_____________________________________________
            #TODO：loss_s1-loss_s4相加得到风格损失loss_s
            loss_s =_____________________________________________
